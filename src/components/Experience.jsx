      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-block px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-md mb-6 shadow-sm">
            <h2 className="text-[9px] uppercase tracking-widest font-bold text-blue-400">My Journey</h2>
          </motion.div>
          <motion.h3 variants={fadeInUp} transition={{ delay: 0.1 }} className="text-4xl md:text-5xl font-bold text-white leading-tight">Career & Education</motion.h3>
        </motion.div>

        <div className="relative">
          {/* Central Line */}
          <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[1px] bg-slate-800 rounded-full shadow-sm"></div>
              ...
              >
                ...
                <div className={`md:w-1/2 ${idx % 2 === 0 ? 'md:pl-12' : 'md:pr-12'}`}>
                  <motion.div 
                    ...
                    className="bg-slate-900/40 border border-slate-800/60 p-6 md:p-8 rounded-2xl shadow-xl group hover:border-blue-500/30 transition-all duration-300 relative overflow-hidden"
                  >
                    ...
                    <div className="flex items-start gap-5 mb-6 relative z-10">
                        <div className="w-16 h-16 rounded-xl bg-white border border-slate-800 flex items-center justify-center shadow-sm flex-shrink-0 group-hover:shadow-md transition-all overflow-hidden p-2">
